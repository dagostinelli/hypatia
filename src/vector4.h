...
HYPAPI vector4 * vector4_addf(vector4 *self, float fT);
HYPAPI vector4 * vector4_subtract(vector4 *self, const vector4 *vT);
HYPAPI vector4 * vector4_subtractf(vector4 *self, float fT);
HYPAPI vector4 * vector4_multiply(vector4 *self, const vector4 *vT);
HYPAPI vector4 * vector4_multiplyf(vector4 *self, float fT);
HYPAPI vector4 * vector4_divide(vector4 *self, const vector4 *vT);
HYPAPI vector4 * vector4_dividef(vector4 *self, float fT);
